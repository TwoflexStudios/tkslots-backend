...
import { csGameRoll, scGameRoll } from "../../types/protobuff/rabbit_fortune";
...
const commands = {
    "client": {
        ...
        "c2s_game_roll": {
            ...
            "aID": 80,
            "file": "pb_game_100031",
            "pak": "pb_game_100031.cs_game_roll"
        }
    },
    "server": {
        "s2c_g_state": {
            ...
            "aID": 2,
            "file": "pb_game_100031",
            "pak": "pb_game_100031.sc_game_info"
        },
        "s2c_game_roll": {
            "name": "s2c_game_roll",
            "mainID": 180,
            "aID": 80,
            "file": "pb_game_100031",
            "pak": "pb_game_100031.sc_game_roll"
        }
    }
}
...
interface RabbitFortuneAttributes {
}

class RabbitFortune extends Game<RabbitFortuneAttributes> {
    ...
    constructor(player: Player, options: GameOptions<RabbitFortuneAttributes>, callbacks?: Callbacks) {
        super(player, 100031, options, commands);
